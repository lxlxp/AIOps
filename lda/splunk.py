...
if __name__ == '__main__':
    ...
    dictionary = Dictionary.load('splunk.dict')
    corpus = np.load('splunk_corpus.npy', allow_pickle=True).tolist()
    docs = np.load('splunk_docs.npy', allow_pickle=True).tolist()
    ...
    model.save('splunk_{}.model'.format(num_topics))
